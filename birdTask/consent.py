...
# Import the metadata writing helper from the local io module.  The built-in
# Python ``io`` module does not provide ``write_metadata``, so we must
# explicitly import from the package's ``io.py``.
